...
export default class RaceScene extends Component {
			...
			<div
				className="aspect-ratio aspect-ratio--16x9 br2 overflow-hidden race-live-stream">
				{
					'localhost' === window.location.hostname ?
						...
						<iframe className="aspect-ratio--object cover" allowFullScreen scrolling="no"
	...
	renderUpcoming() {
		...
		return <div className='relative z-1 mt5'>
			...
			<div className="races-wrap flex flex-wrap items-center mt3 nl3 nr3 cb" ref={el => {
				this.stagger( el );
