...
export default function TeamScene() {
	return <Scene id='team' bgChildren={''}>
		<div className="flex flex-wrap flex-nowrap-ns mt6 pt5 relative">
			<HugeBgText style={{top: 0}}>Team</HugeBgText>
			<h2 className="scene-title pv4 w-100 w5-ns tl-ns relative">Team</h2>
		...
		<div className="flex flex-wrap flex-nowrap-ns mt6 pt5 relative">
			...
			<h2 className="scene-title pv4 w5-ns tl-ns relative">Partners</h2>
			<div className="relative w-auto f5">
